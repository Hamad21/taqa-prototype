...
for i,(k,v) in enumerate([("Prepared for","IT Department"),("Prepared by","______________________"),("Team","Quality – Power Technical Support"),("Date","______________")]):
...
h(doc,1,"Purpose")
para(doc,"The Quality Team (Power Technical Support) has prepared an internal web portal that gives field and office teams a single place to find controlled quality documents and technical guidance. This document asks IT to host the portal on an approved internal location and to advise on the preferred platform.")
...
bullet(doc,"nine downloadable documents — six controlled Quality Team checklists (Word) plus three supporting awareness PDFs — each with a reference number and revision (register below).")
...
bullet(doc,"the checklist and awareness content is Quality Team good-practice; confirm ownership and where the controlled master copies will live.", boldlead="Document ownership — ")
bullet(doc,"contact addresses are currently placeholders and must be replaced with the real Quality Team mailbox and names.", boldlead="Contact details — ")
...
fr=fp.add_run("Quality Team, Power Technical Support  ·  TAQA Distribution  ·  Internal — deployment request")
