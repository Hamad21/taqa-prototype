...
Internal portal for the Power Quality Team (Power Technical Support), styled with the
...
- **Quality Awareness Corner**: downloadable good-practice PDFs, plus the Jointing in Weather Conditions guidance page (`jointing-weather-conditions.html`) and its printable field-guide PDF.
- **Power Quality Team contacts**: the team inbox and individual contacts.
...
- Contacts list the Power Quality Team: team inbox `powerquality.team@taqadistribution.com` plus six named contacts.
